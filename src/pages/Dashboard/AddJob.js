...
import { clearValues, handleChange, createJob, editeJob } from "../../features/job/jobSlice";
...
const AddJob = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (isEditing) {
            dispatch(editJobId({ jobId: editJobId, job: { position, company, jobLocation, jobType, status } }))
        }
